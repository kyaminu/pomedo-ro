...
//HTML画像タグ
const pome_hppy_tag = `<img src="${pome_happy_url}" id="pome_happy_img" style="${pome_style}">`;
const pome_angry_tag = `<img src="${pome_angry_url}" id="pome_angry_img" style="${pome_style}">`;
...
//dialogの共通css
const dialog_style = `width: 300px; height: 100px; border: none; border-radius: 10px; background-size: 100% 100%;`
